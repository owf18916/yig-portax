...
**IMPORTANT: Check existing related tables FIRST before creating new migration and if table exist but doesn't contain the expected fields based on this doc, then update the current migration file rather than adding new migration file**
